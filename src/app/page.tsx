    ...
    switch (post.data().text.length) {
        ...
        if (Number(post.id) % 2 == 0) {
          return (
            <div className="animate-marquee-3 my-12">
              <span className="text-[360px] text-slate-800 dark:text-white font-bold scale-150">
                {post.data().text}
              </span>
            </div>
          );
          ...
          return (
            <div className="animate-marquee-3 ">
          ...
          return (
            <div className="animate-marquee-3 my-96">
              <span className="text-[240px] text-cyan-500 font-bold ">
                {post.data().text}
              </span>
            </div>
          );
      ...
      case 4:
        if (Number(post.id) % 2 == 0) {
          ...
          return (
            <div className="animate-marquee-4 mt-[1000px]">
          ...
          return (
            <div className="animate-marquee-4 my-48">
      ...
      default:
        if (Number(post.id) % 4 == 1) {
          ...
          return (
            <div className="animate-marquee-3 mt-[1300px]">
      ...
      <div className="bg-white dark:bg-slate-800">
        ...
        <div className="-z-10">
          <div className="h-screen w-screen flex flex-col justify-center items-center">
            <p className="text-[240px] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
              文化祭コメント掲示板
            </p>
            <InputBox />
          </div>
